...
def initialize_nnformer_1(threeD=True, num_classes=2):
    """
    ...
    network = swintransformer(default_dict["num_input_channels"], default_dict["base_num_features"], default_dict["num_classes"], len(default_dict["net_num_pool_op_kernel_sizes"]),
    ...
    print("nnFormer_1 have {} paramerters in total".format(
