...
class Generic_UNet(SegmentationNetwork):
    ...
    def forward(self, x):
        ...
        for u in range(len(self.tu)):
            ...
            # path = '/home/ps/disk12t/xinrui/coarse_to_fine_nnformer/step1_nnFormer/nnformer/DATASET/nnFormer_raw_data_base/nnFormer_raw_data/Task003_FGR/feature'
            # path1 = os.path.join(path,str(u)+'.npy')
            # np.save(path1,x.cpu())
            # print('ryanryanryanryanryan')
            # print(x.cpu().shape)
            # output = nn.AdaptiveAvgPool3d(1)(x)
            # path2 = os.path.join(path,str(u)+'_after_pooling.npy')
            # np.save(path2,output.cpu())
            # print('xrxrxrxrxrxrxrxrxrxrxr')
...
def initialize_network(threeD=True, num_classes=2):
    ...
    network = Generic_UNet(default_dict["num_input_channels"], default_dict["base_num_features"], default_dict["num_classes"],
                           len(default_dict["net_num_pool_op_kernel_sizes"]),
